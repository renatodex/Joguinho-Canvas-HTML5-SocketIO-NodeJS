...
io.sockets.on('connection', function (socket) {
  ...
  socket.on('insertHeroName', function(heroName, x, y, fn) {
    ...
    if(heroName === 'Chuck Norris') {
      ...
      possibleHero = myHeroesObj.getHeroByName(heroName);
      if(possibleHero) {
        console.log("Este heroi ja existe!");
        fn(false, "Este heroi ja existe!");
      } else {
        console.log("Heroi inserido com sucesso!");
        socket.set('heroName', heroName, function () {
          
          myHeroesObj.createHero(heroName, x, y);
...
app.get('/tests', function startGame(req,res) {
